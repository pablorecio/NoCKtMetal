...
/**
 * Menu de tamaño variable (distinto de la pantalla completa).
 */
class MenuVariable: public Menu {
public:
	MenuVariable();
    MenuVariable(const char* urlFondo, const char* urlCursor, Pantalla* p,
    		Uint32 tamX, Uint32 tamY, Uint32 posX, Uint32 posY);

    virtual ~MenuVariable();
private:
	Uint32 _ancho;
	Uint32 _alto;
	Uint32 _posX;
