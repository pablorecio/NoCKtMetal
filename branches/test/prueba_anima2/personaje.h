...
public:
     ...
     * pantalla.
     */
    Uint32 getX() const; // Podemos considerar la pantalla por tiles.
    /**
     ...
     * pantalla.
     */
    Uint32 getY() const; // Podemos considerar la pantalla por tiles.
    /**
     * Metodo observador de la posicion horizontal del personaje en la pantalla.
     ...
     * de movimiento.
     * @param x Posición horizontal en pixels. TILES
     * @param y Posición vertical en pixels.  TILES
    ...
    /**
     * Metodo modificador de la posicion en pantalla (en <i>pixels</i>). TILES
     * @param x Posicion horizontal.
     * @param y Posicion vertical.
     */
     ...
     * @param margenIzdo Margen izquierdo del rango. TILE ESQUINA
     * @param margenArriba Margen superior del rango. SUP IZQUDA
     * @param rangoAncho Ancho del rango. CUANTOS TILES CONTENDRA
     * @param rangoAlto Alto del rango.       EL RECTANGULO
     */
    void setRango(Uint16 margenIzdo, Uint16 margenArriba, Uint16 rangoAncho,
                  Uint16 rangoAlto);
    /**
     * Metodo modificador de la posicion en el mapa. TILES
     ...
     * @param desp Desplazamiento, por defecto 0. TILES
     */
...
protected:
    ...
    Uint32 _mapaY;
    /**
     * Coordenada horizontal en pixels en la pantalla. TILES
     */
    Uint32 _x;
    /**
     * Coordenada vertical en pixels en la pantalla. TILES
     */
    Uint32 _y;
    /**
...
//inline SDL_Rect* Personaje::getRango() const { return &(_rango); }
